...
if ($? == "0") then
  cd /usr/src/etc/
  date >> /root/FreeBSD-System-Maintenance/upgrade_system/progress.txt
  echo "/usr/sbin/mergemaster" >> /root/FreeBSD-System-Maintenance/upgrade_system/progress.txt
  echo "" >> /root/FreeBSD-System-Maintenance/upgrade_system/progress.txt
...
if ($? == "0") then
  ...
  echo "mergemaster failed" >> /root/FreeBSD-System-Maintenance/upgrade_system/progress.txt
  exit 0
endif
